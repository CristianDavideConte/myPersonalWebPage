...
function updateWindowSize(){
	...
	window.requestAnimationFrame(() => {
		...
		if(_currentWindowInnerHeight > windowInnerHeight + windowInnerHeightOffset)		//If the window gets higher all the variables are always updated
			...
			_update(_currentWindowInnerHeight);
		else if (_currentWindowInnerHeight <= 3 / 4 * windowInnerHeight) 		//Here the window hasn't change orientation and its height is decrease by 50px in respect to the previous windowInnerHeight value
			_update(_currentWindowInnerHeight);
