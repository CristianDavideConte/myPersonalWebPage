...
function desktopEventListenerInitialization() {
	...
	headerElement.addEventListener("scroll", event => event.stopPropagation(), {passive:false});										//Scroll on the header is not allowed
	...
	headerBackgroundElement.addEventListener("scroll", event => event.stopPropagation(), {passive:false});					//Scroll on the headerBackground is not allowed
